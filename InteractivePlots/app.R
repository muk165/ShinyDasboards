  ...
  navbarPage(
    ...
    tabPanel(
      ...
      sidebarLayout(
        sidebarPanel(
          h3(
            "Exploring interactive mechanisms between visualizations and tables", 
            style = "padding-bottom: 20px font: bold;"
          )
        ),
        mainPanel(
          a(
            href="https://github.com/muk165/Shiny-Dashboards-Features", 
    ...
    tabPanel(
      ...
      navlistPanel(
        "Two Versions",
        tabPanel(h6("Select any row in the Table"),
                 box(fluidRow(
        ...
        tabPanel(h6("Select a region in Scatter plot"), 
